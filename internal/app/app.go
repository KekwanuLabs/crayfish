...
func (a *App) Start(ctx context.Context) error {
	...
	// 7. Google OAuth client (always created — credentials embedded in binary)
	...
	if a.googleToken != nil && a.googleToken.RefreshToken != "" && a.Config.GmailUser != "" {
	...
	// 7c. Google OAuth tools (always registered — agent can offer to connect)
