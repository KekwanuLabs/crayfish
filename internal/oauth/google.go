...
// Embedded client credentials for the Crayfish GCP project.
// These are safe to embed — Google's security model for "TVs and Limited Input devices"
// OAuth clients does not treat the client secret as confidential.
// Same pattern used by Chromium, Thunderbird, and other installed apps.
const (
	CrayfishClientID     = "1053231773356-qg13ed17haina34j478frjq42kav1onj.apps.googleusercontent.com"
	CrayfishClientSecret = "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"
)
